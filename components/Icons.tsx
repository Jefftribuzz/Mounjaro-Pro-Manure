...
export const FoodIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M10.9 5.8 21 15.9"/><path d="M16 21h-2a4 4 0 0 1-3.9-3.3L10 10l-3.3-.8A4 4 0 0 1 3.5 5.4 20.3 20.3 0 0 1 6.5 2.3a.5.5 0 0 1 .6.1l4 4a.5.5 0 0 1-.2.7Z"/></svg>
);

export const CheckCircleIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><path d="m22 4-12 12-4-4"/></svg>
);
...
export const SparklesIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="m12 3-1.912 5.813a2 2 0 0 1-1.275 1.275L3 12l5.813 1.912a2 2 0 0 1 1.275 1.275L12 21l1.912-5.813a2 2 0 0 1 1.275-1.275L21 12l-5.813-1.912a2 2 0 0 1-1.275-1.275L12 3Z"/><path d="M5 3v4"/><path d="M9 5H1"/><path d="M20 21v-4"/><path d="M22 19h-4"/></svg>
);
...
export const AppLogo = ({ className = "h-12 w-auto" }: { className?: string }) => {
  const [error, setError] = useState(false);

  // If the image fails to load (e.g., not uploaded yet), show a nice SVG text fallback
  if (error) {
    return (
      <svg viewBox="0 0 230 40" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
         <text x="0" y="28" fontFamily="sans-serif" fontWeight="bold" fontSize="24" fill="#7e22ce">mounjaro</text>
         <text x="115" y="28" fontFamily="sans-serif" fontWeight="500" fontSize="24" fill="#f97316">pro nature</text>
      </svg>
    );
  }
